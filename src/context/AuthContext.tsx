...
interface AuthContextType {
  ...
  isLoading: boolean; // for login/register
  appLoading: boolean; // for global/session/profile
}
...
export const AuthProvider: React.FC<AuthProviderProps> = ({ children }) => {
  ...
  const [appLoading, setAppLoading] = useState(true); // for global/session/profile
